...
bibliography: 3_real_data_statistics.bib
output:
  pdf_document:
        beamer_presentation:
            slide_level: 1
...
<!-- # Reminder: CK TODO: -->
<!--  -->
<!-- - Mention some tutorials on how to learn more about R and how to use it -->
<!--  -->
<!-- - Quality checking etc, franchement je pense que ce n'est pas intéressant. On  -->
<!--   ne peut pas en 3h leur parler de toutes les statistiques, et en même  -->
<!--   expliquer comment faire du QC, en plus ils n'ont aucune notion de ce qu'on a  -->
<!--   fait pour générer un fichier vcf. -->
<!--  -->
<!-- - Some reminders on how to use Rstudio: -->
<!--     - the different windows -->
<!--     - write your code in a script/text file, run the code by "sending" the line to the console -->
<!--     - save your script regularly -->
<!--     - learn about the environment window -->
<!--     - learn about the help and plotting windows -->
<!--     - learn how to get help from inside R. -->
<!--  -->
<!-- # Reading input data: a vcf file -->
<!--  -->
<!-- - Reminder of the vcf standard -->
...
```{r}
library_file <- "./3_real_data_statistics_lib.R"
source(library_file)
```
...
input_vcf_model_1 <- "./Model-1_10000_indep_markers.vcf"
...
fasta_file <- "./Model-2_30_sequences_1000bp.fasta"
...
input_file <- "./Model-4_1000_sequences_LowRecombination.fasta"
...
# With only one locus
fasta_file_model_3 <- "Model-3_500000_chromosome_LD.fasta"
